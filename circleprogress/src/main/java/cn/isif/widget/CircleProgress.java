...
public class CircleProgress extends View {
    ...
    public CircleProgress(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        default_text_size = Utils.sp2px(getResources(), 13);
        min_size = (int) Utils.dp2px(getResources(), 35);
        default_stroke_width = Utils.dp2px(getResources(), 2);
        default_inner_bottom_text_size = Utils.sp2px(getResources(), 13);
    ...
    protected void initByAttributes(TypedArray attributes) {
        finishedStrokeColor = attributes.getColor(R.styleable.DonutProgress_c_finished_color, default_finished_color);
        unfinishedStrokeColor = attributes.getColor(R.styleable.DonutProgress_c_unfinished_color, default_unfinished_color);
        textColor = attributes.getColor(R.styleable.DonutProgress_c_text_color, default_text_color);
        textSize = attributes.getDimension(R.styleable.DonutProgress_c_text_size, default_text_size);

        setMax(attributes.getInt(R.styleable.DonutProgress_c_max, default_max));
        setProgress(attributes.getInt(R.styleable.DonutProgress_c_progress, 0));
        finishedStrokeWidth = attributes.getDimension(R.styleable.DonutProgress_c_finished_stroke_width, default_stroke_width);
        unfinishedStrokeWidth = attributes.getDimension(R.styleable.DonutProgress_c_unfinished_stroke_width, default_stroke_width);
        if (attributes.getString(R.styleable.DonutProgress_c_prefix_text) != null) {
            prefixText = attributes.getString(R.styleable.DonutProgress_c_prefix_text);
        }
        if (attributes.getString(R.styleable.DonutProgress_c_suffix_text) != null) {
            suffixText = attributes.getString(R.styleable.DonutProgress_c_suffix_text);
        }
        if (attributes.getString(R.styleable.DonutProgress_c_text) != null) {
            text = attributes.getString(R.styleable.DonutProgress_c_text);
        }
        innerBackgroundColor = attributes.getColor(R.styleable.DonutProgress_c_background_color, default_inner_background_color);

        innerBottomTextSize = attributes.getDimension(R.styleable.DonutProgress_c_inner_bottom_text_size, default_inner_bottom_text_size);
        innerBottomTextColor = attributes.getColor(R.styleable.DonutProgress_c_inner_bottom_text_color, default_inner_bottom_text_color);
        innerBottomText = attributes.getString(R.styleable.DonutProgress_c_inner_bottom_text);

        startingDegree = attributes.getInt(R.styleable.DonutProgress_c_circle_starting_degree, default_startingDegree);
    }
