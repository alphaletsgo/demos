...
public class VideoMediaController extends FrameLayout implements
	...
	public void setPlayState(PlayState playState) {
		mPlayImg.setImageResource(playState.equals(PlayState.PLAY) ? R.drawable.fi_video_pause
				: R.drawable.fi_video_play);
	}
	...
	private void initView(Context context) {
		View.inflate(context, R.layout.fi_video_media_controller, this);
